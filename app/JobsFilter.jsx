...
import JobsList from "@/app/JobsList";
...
export default function JobsFilter() {
  ...
  return (
    <main className=" px-12 py-5 lg:grid grid-cols-7 min-h-screen gap-7">
      <section className="hidden lg:block lg:col-span-2 py-3 rounded-md shadow-md ring-1 ring-slate-200/70">
